...
ModelInfo gem provides all *models*(available in your application including engine's model) CRUD and all *associations* of each model and their CRUD.
...
The download option for EXCEL would be provided in an initializer file to make it true or false and also I will provide site logo and title option in an initializer file.
...
*NOTE*: For now this gem properly supports rails < 5
